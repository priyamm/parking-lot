...
public class ParkingLot {
    ...
    public String getRegistrationNumbersByCarColor(String color) {
        ...
        return registrationNumbers.charAt(registrationNumbers.length() - 1) == ',' ? registrationNumbers.substring(0, registrationNumbers.length() - 1) : registrationNumbers;
    }
    ...
    public String getSlotNumbersByCarColor(String color) {
        ...
        return slotNumbers.charAt(slotNumbers.length() - 1) == ',' ? slotNumbers.substring(0, slotNumbers.length() - 1) : slotNumbers;
    }
